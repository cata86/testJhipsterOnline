package it.cineca.test.web.rest;

import it.cineca.test.TestJhipsterOnlineApp;
import it.cineca.test.domain.Authority;
import it.cineca.test.domain.User;
import it.cineca.test.repository.UserRepository;
import it.cineca.test.security.AuthoritiesConstants;
import it.cineca.test.service.MailService;
import it.cineca.test.service.UserService;
import it.cineca.test.service.dto.UserDTO;
import it.cineca.test.service.mapper.UserMapper;
import it.cineca.test.web.rest.errors.ExceptionTranslator;
import it.cineca.test.web.rest.vm.ManagedUserVM;
